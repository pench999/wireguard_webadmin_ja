...
from wireguard_peer.views import view_manage_ip_address, view_wireguard_peer_list, view_wireguard_peer_manage, \
    ...
    view_wireguard_peer_suspend, view_wireguard_peer_schedule_profile, view_wireguard_peer_mfa_unlock
...
urlpatterns = [
    ...
    path('mfa_unlock/', view_wireguard_peer_mfa_unlock, name='wireguard_peer_mfa_unlock'),
