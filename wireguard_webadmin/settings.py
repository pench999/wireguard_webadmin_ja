...
MIDDLEWARE = [
    ...
    'user_manager.middleware.VpnUserPortalMiddleware',
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'user_manager.password_validation.CharacterClassPasswordValidator',
    },
    {
...
WIREGUARD_PEER_INACTIVE_SECONDS = 300
