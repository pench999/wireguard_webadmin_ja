...
from user_manager.views import view_manage_user, view_peer_group_list, view_peer_group_manage, view_user_list, \
    view_user_mfa_devices, view_user_mfa_disable, view_user_mfa_qrcode, view_user_mfa_setup, view_user_password_change
...
urlpatterns = [
    ...
    path('mfa/devices/', view_user_mfa_devices, name='user_mfa_devices'),
    path('mfa/qrcode/', view_user_mfa_qrcode, name='user_mfa_qrcode'),
    path('mfa/disable/', view_user_mfa_disable, name='user_mfa_disable'),
    path('password/', view_user_password_change, name='user_password_change'),
